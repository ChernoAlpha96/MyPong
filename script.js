...
var colors = ['#1abc9c', '#2ecc71', '#3498db', '#b0ddbf', '#9b59b6'];
...
var Game = {
  ...
  endGameMenu: function (text) {
      ...
      Pong.context.fillStyle = '#ed991cf';
  ...
  update: function () {
      ...
      // Check to see if the ai/AI has won the round.
          ...
          this.over = true;
          setTimeout(function () { Pong.endGameMenu('Game Over - por seco!'); }, 1000);
      }
  },
  ...
  draw: function () {
      ...
      this.context.font = '150px Courier New';
